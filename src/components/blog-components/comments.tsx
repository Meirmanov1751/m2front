      ...
      <div>
        ...
        <div className="ltn__comment-reply-area ltn__form-box mb-60---">
          ...
          <form action="#">
            ...
            <label className="mb-0 input-info-save"><input type="checkbox" name="agree"/> Save my name, email, and
              website in this browser for the next time I comment.</label>
            <div className="btn-wrapper">
              <button className="btn theme-btn-1 btn-effect-1 text-uppercase" type="submit"><i
                className="far fa-comments"/> Post Comment
              </button>
            </div>
          </form>
        </div>
