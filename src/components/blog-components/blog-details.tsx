...
const BlogDetails = function (props: any) {
  ...
  let newsImage: any = newsimageData && newsimageData.find((image) => image.NewsId == props.data._id)
          ...
          <div className="col-lg-12">
            <div className="ltn__blog-details-wrap">
              <div className="ltn__page-details-inner ltn__blog-details-inner">
                ...
                <div className="ltn__blog-img" style={{display: "flex", justifyContent: "center", background: "black"}}>
                  <Image src={imageURL ? imageURL : defaultImage} alt={props.data.title} style={{width: "100%"}}/>
                </div>
