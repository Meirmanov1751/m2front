                ...
                <ul className="justify-content-start">
                  <li>
                    <div className="ltn__grid-list-tab-menu ">
                      <div className="nav">
                        <a className="active show" data-bs-toggle="tab" href="#liton_product_grid"><i
                      ...
                      <div className="col-xl-6 col-sm-6 col-12">
                        <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                          <div className="product-img go-top">
                            ...
                            <div className="real-estate-agent">
                              <div className="agent-img">
                                <Link href="/shop"><Image src={"assets/img/blog/author.jpg"} fill={true}
                                                          alt="#"/></Link>
                              </div>
                            </div>
                          </div>
                          <div className="product-info">
                            ...
                            <h2 className="product-title go-top"><Link href="/product-details">New Apartment Nice
                              View</Link></h2>
