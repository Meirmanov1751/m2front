...
class OrderTrackingV extends Component {
  render() {
    let anchor = '#'
    let imagealt = 'image'
            ...
            <div className="col-lg-8 offset-lg-2">
              <div className="account-login-inner section-bg-1">
                <form method="get" className="ltn__form-box contact-form-box">
                  <p className="text-center"> To track your order please enter your Order ID in the box below and press
                    the "Track Order" button. This was given to you on your receipt and in the confirmation email you
