      ...
      <div className="col-lg-4  mb-100">
        <aside className="sidebar ltn__shop-sidebar">
          ...
          <div className="widget ltn__top-rated-product-widget d-none">
            ...
            <ul>
              <li>
                <div className="top-rated-product-item clearfix">
                  <div className="top-rated-product-img">
                    {/*<a href="product-details.html"><Image src="img/product/1.png" alt="#"/></a>*/}
                  </div>
              ...
              <li>
                <div className="top-rated-product-item clearfix">
                  <div className="top-rated-product-img">
                    <a href="product-details.html"><Image src="img/product/2.png" alt="#"/></a>
                  </div>
                  <div className="top-rated-product-info">
                    <div className="product-ratting">
                      <ul>
              ...
              <li>
                <div className="top-rated-product-item clearfix">
                  <div className="top-rated-product-img">
                    <a href="product-details.html"><Image src="img/product/3.png" alt="#"/></a>
                  </div>
                  <div className="top-rated-product-info">
                    <div className="product-ratting">
                      <ul>
          ...
          <div className="widget ltn__banner-widget d-none">
            <a href="shop.html"><Image src="img/banner/banner-2.jpg" alt="#"/></a>
          </div>
        </aside>
      </div>
    )
