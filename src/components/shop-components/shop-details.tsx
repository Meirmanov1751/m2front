        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
              ...
              <label><span className="ltn__secondary-color"><i className="flaticon-pin"/></span> Belmont Gardens,
                Chicago</label>
              ...
              <p>To the left is the modern kitchen with central island, leading through to the unique breakfast family
                room which feature glass walls and doors out onto the garden and access to the separate utility
                room.</p>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <a href={publicUrl + "assets/img/others/14.jpg"} data-rel="lightcase:myCollection">
                      <Image className="mb-30" src={publicUrl + "assets/img/others/14.jpg"} alt="Image"/>
                    </a>
                    <a href={publicUrl + "assets/img/others/15.jpg"} data-rel="lightcase:myCollection">
                      <Image className="mb-30" src={publicUrl + "assets/img/others/15.jpg"} alt="Image"/>
                    </a>
                  </div>
                  <div className="col-md-6">
                    <a href={publicUrl + "assets/img/others/16.jpg"} data-rel="lightcase:myCollection">
                      <Image className="mb-30" src={publicUrl + "assets/img/others/16.jpg"} alt="Image"/>
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div
                className="ltn__shop-details-tab-content-inner--- ltn__shop-details-tab-inner-2 ltn__product-details-review-inner mb-60">
                  ...
                  <div className="ltn__comment-inner">
                    <ul>
                      <li>
                        <div className="ltn__comment-item clearfix">
                          ...
                          <div className="ltn__commenter-comment">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, omnis fugit corporis
                              iste magnam ratione.</p>
                      ...
                      <li>
                        <div className="ltn__comment-item clearfix">
                          <div className="ltn__commenter-img">
                            <Image src={publicUrl + "assets/img/testimonial/2.jpg"} alt="Image"/>
                          </div>
                          <div className="ltn__commenter-comment">
                            <h6><a href="#">Adam Smit</a></h6>
                            <div className="product-ratting">
                ...
                <div className="ltn__comment-reply-area ltn__form-box mb-30">
                  <form action="#">
                    ...
                    <label className="mb-0"><input type="checkbox" name="agree"/> Save my name, email, and website in
              ...
              <div className="row">
                ...
                <div className="col-xl-6 col-sm-6 col-12 go-top">
                  <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                    <div className="product-img">
                      <Link href="/shop"><Image src={publicUrl + "assets/img/product-3/1.jpg"} alt="#"/></Link>
                ...
                <div className="col-xl-6 col-sm-6 col-12 go-top">
                  <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                    <div className="product-img">
                      <Link href="/shop"><Image src={publicUrl + "assets/img/product-3/2.jpg"} alt="#"/></Link>
                      <div className="real-estate-agent">
                        <div className="agent-img">
                          <Link href="/team-details"><Image src={publicUrl + "assets/img/blog/author.jpg"}
                                                            alt="#"/></Link>
              ...
              <div className="widget ltn__top-rated-product-widget go-top">
                ...
                <ul>
                  ...
                  <li>
                    <div className="top-rated-product-item clearfix">
                      <div className="top-rated-product-img">
                        {/*<Link href="/product-details"><Image src={publicUrl + "assets/img/product/3.png"}*/}
                        {/*                                     alt="#"/></Link>*/}
                      </div>
                      <div className="top-rated-product-info">
                        <div className="product-ratting">
              ...
              <div className="widget ltn__popular-product-widget">
                ...
                <div className="row ltn__popular-product-widget-active slick-arrow-1">
                  ...
                  <div className="col-12">
                    <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                      <div className="product-img go-top">
                        <Link href="/shop"><Image src={publicUrl + "assets/img/product-3/6.jpg"} alt="#"/></Link>
                        <div className="real-estate-agent">
                          <div className="agent-img">
                            <Link href="/team-details"><Image src={publicUrl + "assets/img/blog/author.jpg"}
                                                              alt="#"/></Link>
                  ...
                  <div className="col-12">
                    <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                      <div className="product-img">
                        <a href="product-details.html"><Image src={publicUrl + "assets/img/product-3/4.jpg"}
                                                              alt="#"/></a>
                        <div className="real-estate-agent">
                          <div className="agent-img">
                            <Link href="/team-details"><Image src={publicUrl + "assets/img/blog/author.jpg"}
                  ...
                  <div className="col-12">
                    <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                      <div className="product-img">
                        <a href="product-details.html"><Image src={publicUrl + "assets/img/product-3/5.jpg"}
                                                              alt="#"/></a>
                        <div className="real-estate-agent">
                          <div className="agent-img">
                            <Link href="/team-details"><Image src={publicUrl + "assets/img/blog/author.jpg"}
