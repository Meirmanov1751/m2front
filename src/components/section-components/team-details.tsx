          ...
          <div className="col-lg-8">
            <div className="ltn__team-details-member-info-details">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                ...
                aspernatur aut odit aut fugit, sed quia consequu ntur magni dolores eos qui ratione voluptatem sequi
                ...
                <div className="col-xl-4 col-sm-6 col-12 go-top">
                  <div className="ltn__feature-item ltn__feature-item-6 text-center">
                    ...
                    <div className="ltn__feature-info">
                      ...
                      <Link className="ltn__service-btn" href="/service-details">Read More <i
                        className="flaticon-right-arrow"/></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="ltn__form-box contact-form-box box-shadow white-bg mt-50">
                ...
                <form id="contact-form" action="mail.php" method="post">
                  ...
                  <p><label className="input-info-save mb-0"><input type="checkbox" name="agree"/> Save my name, email,
                    and website in this browser for the next time I comment.</label></p>
                  <div className="btn-wrapper mt-0">
                    <button className="btn theme-btn-1 btn-effect-1 text-uppercase" type="submit">get an free service
                    </button>
                  </div>
