          ...
          <div className="col-lg-12">
            <div className="ltn__car-dealer-form-tab">
              <div className="ltn__tab-menu  text-uppercase">
                <div className="nav">
                  <a className="active show" data-bs-toggle="tab" href="#ltn__form_tab_1_1"><i className="fas fa-home"/>Rent
                    Home</a>
                    ...
                    <form action="#" className="ltn__car-dealer-form-box row">
                      ...
                      <div className="car-price-filter-range col-lg-12">
                        ...
                        <div className="btn-wrapper text-center">
                          ...
                          <Link href="/shop-right-sidebar" className="btn theme-btn-1 btn-effect-1 text-uppercase">Search
                            Inventory</Link>
                        </div>
                      </div>
                    </form>
