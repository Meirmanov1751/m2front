      ...
      <div className="container">
        ...
        <div className="ltn__gallery-active row ltn__gallery-style-2 ltn__gallery-info-hide---">
          ...
          <div className="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Portfolio
                  Link </Link></h4>
          ...
          <div className="ltn__gallery-item filter_category_2 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Inline
                  Description </Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
          ...
          <div className="ltn__gallery-item filter_category_1 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Youtube
                  Video </Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
          ...
          <div className="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Vimeo
                  Video </Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
          ...
          <div className="ltn__gallery-item filter_category_2 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">HTML5
                  Video </Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
          ...
          <div className="ltn__gallery-item filter_category_1 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Google
                  Map </Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
          ...
          <div className="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Image
                  Caption </Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
          ...
          <div className="ltn__gallery-item filter_category_2 col-lg-4 col-sm-6 col-12">
            <div className="ltn__gallery-item-inner">
              ...
              <div className="ltn__gallery-item-info">
                <h4 className="go-top"><Link href="/m2front/src/components/section-components/portfolio-details">Not
                  Found</Link></h4>
                <p>Web Design &amp; Development, Branding</p>
              </div>
            </div>
        ...
        <div id="ltn__inline_description_1" style={{display: 'none'}}>
          ...
          <p>Vivamus fringilla congue laoreet. Quisque ultrices sodales orci, quis rhoncus justo auctor in. Phasellus
            dui eros, bibendum eu feugiat ornare, faucibus eu mi. Nunc aliquet tempus sem, id aliquam diam varius ac.
            Maecenas nisl nunc, molestie vitae eleifend vel.</p>
        </div>
