          ...
          <div className="col-lg-8">
            <div className="ltn__page-details-inner ltn__portfolio-details-inner">
              ...
              <p><span className="ltn__first-letter">L</span>orem ipsum dolor sit amet, consectetur adipisicing elit,
                ...
                nostrud exerc itation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
              ...
              <div className="ltn__service-list-menu text-uppercase mt-50 d-none">
                <ul>
                  <li><i className="fas fa-car"/> Front Brakes Repair <span className="service-price">$225.95 <span>Plus Parts</span></span>
                  </li>
                  <li><i className="fas fa-life-ring"/> Rear Brakes Repair <span
                    className="service-price">$225.95 <span>Plus Parts</span></span></li>
                  <li><i className="fas fa-cog"/> Axle <span
                    className="service-price">$225.95 <span>Plus Parts</span></span></li>
                  <li><i className="fas fa-car"/> Starters / Alternators <span className="service-price">$225.95 <span>Plus Parts</span></span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4">
            <aside className="sidebar-area ltn__right-sidebar">
              ...
              <div className="widget-2 ltn__menu-widget ltn__menu-widget-2 text-uppercase">
                <ul className="go-top">
                  <li><Link href="/portfolio">Property Management <span><i
                    className="fas fa-arrow-right"/></span></Link></li>
                  <li className="active"><Link href="/portfolio">Mortgage Service <span><i
                    className="fas fa-arrow-right"/></span></Link></li>
                  <li><Link href="/portfolio">Consulting Service <span><i className="fas fa-arrow-right"/></span></Link>
                  </li>
                  ...
                  <li><Link href="/portfolio">Escrow Services <span><i className="fas fa-arrow-right"/></span></Link>
                  </li>
                </ul>
              </div>
              {/* Newsletter Widget */}
              <div className="widget ltn__search-widget ltn__newsletter-widget">
                <h5 className="ltn__widget-sub-title"> subscribe</h5>
                <h4 className="ltn__widget-title">Get Newsletter</h4>
                <form action="src/components/section-components/portfolio-details#">
