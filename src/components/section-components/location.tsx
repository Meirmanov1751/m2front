          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="ltn__map-item">
                ...
                <h5 className="ltn__location-single-info"><i className="fas fa-map-marked-alt"/>5816 S. Coulter Street
                  Amarillo, <br/> TX 79119</h5>
                <h4 className="ltn__location-single-info"><i className="fas fa-phone-volume"/>0123456789</h4>
                <div className="btn-wrapper">
                  <a href="appointment.html" className="btn btn-transparent btn-border btn-effect-4"><i
                    className="fas fa-location-arrow"/> Get An Appointment</a>
                  <a href="#" className="btn btn-transparent btn-border btn-effect-3"><i className="fas fa-globe"/> View
                    Website</a>
                </div>
              </div>
            </div>
