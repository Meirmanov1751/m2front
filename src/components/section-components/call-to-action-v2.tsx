...
class CallToActonV2 extends Component {
  render() {
    ...
    return <div className="ltn__call-to-action-area ltn__call-to-action-4 bg-image pt-115 pb-120 "
          ...
          <div className="col-lg-12">
            <div className="call-to-action-inner call-to-action-inner-4 text-center">
              <div className="section-title-area ltn__section-title-2">
                <h5 className="section-subtitle ltn__secondary-color"> any question you have </h5>
              ...
              <div className="btn-wrapper">
                ...
                <span className="go-top"><Link href="/contact"
                                               className="btn btn-transparent btn-effect-3 white-color go-top">CONTACT US</Link></span>
              </div>
            </div>
          </div>
        </div>
