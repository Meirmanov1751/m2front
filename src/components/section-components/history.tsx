...
class HistoryV1 extends Component {
  render() {
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6 align-self-center">
                        <div className="about-us-info-wrap">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eius mod tempor
                            incididunt ut labore et dolore magna aliqua. consectetur adipis icing elit, sed do eius mod
                            t</p>
                        </div>
                      </div>
                    </div>
